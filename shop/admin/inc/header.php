...
<body>
    <div class="container_12">
        <div class="grid_12 header-repeat">
            ...
            <li><a href="?action=logout">Logout</a></li> <!-- I just pass the logout id from here -->
        ...
        <div class="grid_12">
            <ul class="nav main">
                <li class="ic-dashboard"><a href="dashbord.php"><span>Dashbord</span></a> </li>
                <li class="ic-form-style"><a href="userprofil.php"><span>User Profile</span></a></li>
		        <li class="ic-grid-tables"><a href="inbox.php"><span>Inbox</span></a></li>
                <li class="ic-grid-tables"><a href="mainorder.php"><span>Order</span></a></li>
                <li class="ic-charts"><a href="https://google.com"><span>Visit Website</span></a></li>
            </ul>
        </div>
        <div class="clear">
        </div>
